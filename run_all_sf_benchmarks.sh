...
./gs-cli/gs-cli -e "\connect 8080; \c sf01; \benchmark gs-cli/consultas100 --cold --restart-cmd \"$SCRIPT_DIR/restart_server.sh\" --name disk_sf01"
...
./gs-cli/gs-cli -e "\connect 8080; \c sf03; \benchmark gs-cli/consultas100 --cold --restart-cmd \"$SCRIPT_DIR/restart_server.sh\" --name disk_sf03"
...
./gs-cli/gs-cli -e "\connect 8080; \c sf1; \benchmark gs-cli/consultas100 --cold --restart-cmd \"$SCRIPT_DIR/restart_server.sh\" --name disk_sf1"
...
./gs-cli/gs-cli -e "\connect 8080; \c sf3; \benchmark gs-cli/consultas100 --cold --restart-cmd \"$SCRIPT_DIR/restart_server.sh\" --name disk_sf3"
